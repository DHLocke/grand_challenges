...
tic();trees<-
  st_read("G:/Shared drives/Grand Challenges/data/bc_forestry_trees_12232020/bc_forestry_trees_12232020.shp");toc() #takes 3 mins to run

trees %>% 
  select() # drop columns to speed up, drop obs that are irrelevant
