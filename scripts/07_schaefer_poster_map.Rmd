...
trees <- read_csv("output_tables/24_25_cleaned.csv")
trees_sf<-st_as_sf(trees,coords = c("long", "lat"), crs = 4326)

```

# All trees sampled summer 2024 and 2025
...
# Spotted Lanternfly observed summer 2024 amd 2025
```{r include=TRUE, echo=FALSE}
...
# Spotted Lanternfly on Liquidambar styraciflua summer 2024 and 2025
```{r include=TRUE, echo=FALSE}
...
# Average SLF per neighborhood summer 2024 and 2025
```{r include=TRUE, echo=FALSE}
