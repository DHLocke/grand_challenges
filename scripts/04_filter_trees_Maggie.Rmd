...
species_to_include <- 
  c("Quercus bicolor","Quercus phellos","Quercus rubra", "Acer saccharinum", "Acer saccharum",
    "Celtis occidentalis", "Celtis laevigata","Carpinus caroliniana", "Gleditsia triacanthos",
    "Tilia americana","Magnolia grandiflora", "Magnolia virginiana","Cercis canadensis")
...
trees <- trees |>
  ...
  filter(SPP %in% species_to_include & # species of interest to Maggie
